      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Experience personalized education with AI tutoring, gamification,
            and social learning. Master any subject at your own pace with our
          ...
          {[
            {
              ...
              description:
                "Get instant help, explanations, and personalized guidance from our AI assistant.",
              color: "text-blue-500",
            },
            {
              icon: Trophy,
              ...
              description:
                "Earn badges, maintain streaks, and climb leaderboards as you progress.",
            ...
            },
            {
              ...
              description:
                "Content adjusts to your pace and learning style automatically.",
          ...
          {[
            {
              ...
              content:
                "The AI tutor is incredible! It's like having a personal teacher available 24/7.",
              rating: 5,
            },
            {
              name: "Mike Chen",
              ...
              content:
                "Gamification keeps me motivated. I've maintained a 30-day streak!",
              rating: 5,
            },
            {
              name: "Emma Davis",
              ...
              content:
                "The adaptive learning system perfectly matches each student's pace.",
              rating: 5,
            },
