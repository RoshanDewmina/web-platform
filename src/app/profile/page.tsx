...
export default function ProfilePage() {
  ...
  const [bio, setBio] = useState(
    "Passionate learner exploring new technologies and expanding my knowledge every day."
  );
  ...
  // AI learning preferences (stored in Clerk publicMetadata.aiProfile)
  const existing = (user?.publicMetadata as any)?.aiProfile || {};
  const [prefGoals, setPrefGoals] = useState<string>(
    existing.goals?.join(", ") || ""
  );
  const [prefDifficulty, setPrefDifficulty] = useState<string>(
    existing.preferredDifficulty || "intermediate"
  );
  const [prefPace, setPrefPace] = useState<string>(existing.pace || "normal");
  const [prefTopics, setPrefTopics] = useState<string>(
    (existing.topicsOfInterest || []).join(", ")
  );
  const [prefLang, setPrefLang] = useState<string>(existing.language || "en");
  const [prefTts, setPrefTts] = useState<boolean>(
    Boolean(existing.accessibility?.tts)
  );
      ...
      <div className="space-y-6">
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="mt-4">
                  ...
                  <Progress
                    value={
                      (profileStats.totalXP / profileStats.nextLevelXP) * 100
                    }
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              ...
              <div className="text-center p-3 rounded-lg bg-secondary">
                ...
                <div className="text-xl font-bold">
                  {profileStats.achievementsUnlocked}
                </div>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {profileStats.coursesInProgress}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">
          ...
          <TabsContent value="achievements" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {profileStats.achievementsUnlocked} of{" "}
                  {profileStats.totalAchievements} unlocked
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="settings" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Learning Preferences (AI)</CardTitle>
                <CardDescription>
                  Personalize recommendations and assistant responses
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="grid md:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      placeholder="e.g., master react hooks, build portfolio"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      value={prefTopics}
                      onChange={(e) => setPrefTopics(e.target.value)}
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={setPrefDifficulty}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    <Label>Pace</Label>
                    <Select value={prefPace} onValueChange={setPrefPace}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Enable TTS in the assistant
                      </p>
                    </div>
                    <Switch checked={prefTts} onCheckedChange={setPrefTts} />
                  </div>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Let others send you requests
                    </p>
                  </div>
                  <Switch
                    defaultChecked={privacySettings.allowFriendRequests}
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    defaultChecked={notificationSettings.socialActivity}
                  />
                </div>
